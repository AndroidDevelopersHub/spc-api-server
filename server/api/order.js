...
async function list(req ,res ){
    ...
    if (req.query.search_string && req.query.search_string !== ''){
        ...
        db.query("SELECT o.id , o.order_id , o.shipping_cost, o.delivered_address , o. user_id , o.status , o.payment_method , o.createdAt,u.username , u.phone FROM orders AS o INNER JOIN users AS u ON o.user_id = u.uid WHERE CONCAT(title) REGEXP '"+req.query.search_string+"'  LIMIT "+limit+" OFFSET "+offset+" ", (err, result) => {
        ...
        db.query("SELECT o.id , o.order_id , o.shipping_cost, o.delivered_address , o. user_id , o.status , o.payment_method , o.createdAt,u.username , u.phone FROM orders AS o INNER JOIN users AS u ON o.user_id = u.uid LIMIT "+limit+" OFFSET "+offset+" ", (err, result) => {
            if (!err) {
                return _response.apiSuccess(res, result.length+" "+responsemsg.found , result , {page: parseInt(page) , limit: parseInt(limit),totalDocs: totalDocs })
