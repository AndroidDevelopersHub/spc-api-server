...
module.exports = function (router) {
    router.get('/refer_level', list);
    router.post('/refer_level', add);
    router.put('/refer_level/:id', update);
    router.get('/refer_level/:id', details);
    router.delete('/refer_level/:id', _delete);
}
